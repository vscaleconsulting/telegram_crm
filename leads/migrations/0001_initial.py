...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='TGBot',
            fields=[
                ('bot_token', models.TextField(primary_key=True, serialize=False)),
                ('usage_count', models.IntegerField(default=0)),
                ('last_used_on', models.DateField(default=django.utils.timezone.now)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='TGSession',
            fields=[
                ('phone_num', models.BigIntegerField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tg_session', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.tgsession')),
            ],
        ),
        migrations.CreateModel(
            name='Agent',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('session', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.tgsession')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('session_used', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='leads.tgsession')),
            ],
            options={
